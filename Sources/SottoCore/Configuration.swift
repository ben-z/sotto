...
public struct Configuration: Codable, Sendable, Equatable {
    ...
    public var captureFocusedContext = false
    public var contextHistoryCount = 0
    ...
    private enum CodingKeys: String, CodingKey {
        case recordingsDirectory, model, language, captureFocusedContext, contextHistoryCount, paste, hotkeyKeyCode, hotkeyModifiers, hotkeyMode, maxRecordingSeconds, audioBitRate, trimWhitespace
    }
    ...
    public init(from decoder: Decoder) throws {
        ...
        captureFocusedContext = try values.decode(Bool.self, forKey: .captureFocusedContext)
        contextHistoryCount = try values.decode(Int.self, forKey: .contextHistoryCount)
    ...
    public func validate() throws {
        ...
        guard (1...3600).contains(maxRecordingSeconds), (16000...128000).contains(audioBitRate), (0...10).contains(contextHistoryCount) else {
            throw SottoError("Invalid limits: recording 1...3600 seconds, bitrate 16000...128000, context history 0...10.")
        }
